...
import getAllProjects from "@/lib/strapi/collection/projects";
import getProjectsPage from "@/lib/strapi/single/projects";
...
export default async function Projects() {
  ...
  return (
    ...
    >
      ...
      >
        {projects.length === 0 && (
          <p className={"text-zinc-400 dark:text-zinc-600 text-center sm:col-span-2 lg:col-span-3"}>
          ...
          <Card as="li" key={index}>
            <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:ring-0">
              <Image
                ...
                alt={project.icon.alternativeText}
                className="h-8 w-8"
                width={128}
                height={128}
                unoptimized
